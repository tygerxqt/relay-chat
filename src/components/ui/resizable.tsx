...
const ResizableHandle = ({
	...
	>
		{withHandle && (
			<div className="z-10 flex items-center justify-center w-3 h-4 border rounded-sm border-neutral-200 bg-neutral-200 dark:border-neutral-800 dark:bg-neutral-800">
